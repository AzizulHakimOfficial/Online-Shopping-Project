...
<html>
    ...
    <body>
        ...
        <table>
            <thead>
                <%
                    ...
                    try {
                        ...
                        ResultSet rs1 = st.executeQuery("select * from cart where email='" + email + "' and address is NULL");
                        while (rs1.next()) {
                            total = total + rs1.getInt(5);
                        }
                %>
                <tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><i class="">BDT </i><%=rs.getString(4)%></td>
                    <td><%=rs.getString(8)%></td>
                    <td><i class="">BDT </i><%=rs.getString(10)%></td>
                </tr>
                <%
                    }
                %>
        ...
        <form action="addressPaymentForOrderAction.jsp" method="post">
            ...
            <div class="left-div">
                <h3>Enter Address</h3>
                <input class="input-style" type="text" name="address" value="<%=rs2.getString(7)%>" placeholder="Enter State" required > 
